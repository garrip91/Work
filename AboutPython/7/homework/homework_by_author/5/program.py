...
*(вместо 4) Написать скрипт, который выводит статистику для заданной папки в виде словаря, в котором ключи те же, а значения - кортежи вида:
...
with open(file=os.path.basename(os.getcwd()) + "_summary.json", mode="w", encoding="utf-8") as f_json:
